...
const cambiarBackgroundConDelay = (
  ...
  setTimeout(() => {
    imageA.style.backgroundColor = "#73ce24";
    imageB.style.backgroundColor = "#73ce24";
  }, delay);
};
    ...
    switch (display) {
      case "DebesDarleAlBotón":
        warningMessageElement.innerHTML =
          "▶️ Primero debes darle al botón 'Empezar la Partida'";
        warningMessageElement.style.backgroundColor = "#F59432";
        break;
      case "YaHasVolteadoEstaCarta":
        warningMessageElement.innerHTML = "⚠️ ¡Carta volteada!";
        warningMessageElement.style.backgroundColor = "#F59432";
        break;
      case "HasCompletadoLaPartida":
        warningMessageElement.innerHTML = "🎉 ¡Encontraste todas las parejas!";
